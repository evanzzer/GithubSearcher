...
import com.leafy.githubsearcher.core.databinding.ItemCardUserBinding
import com.leafy.githubsearcher.core.domain.model.User

class CardUserAdapter : RecyclerView.Adapter<CardUserAdapter.UserViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): UserViewHolder {
        val binding =
            ItemCardUserBinding.inflate(LayoutInflater.from(parent.context), parent, false)
